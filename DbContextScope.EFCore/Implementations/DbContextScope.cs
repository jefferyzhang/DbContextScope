...
" + Environment.StackTrace;
        ...
        private static readonly AsyncLocal<InstanceIdentifier> instanceIdentifierMap = new AsyncLocal<InstanceIdentifier>();
        ...
        internal static void SetAmbientScope(DbContextScope newAmbientScope)
        {
            ...
            var current = instanceIdentifierMap.Value;
            ...
            instanceIdentifierMap.Value = newAmbientScope._instanceIdentifier;
        ...
        {
            var current = instanceIdentifierMap.Value;
            instanceIdentifierMap.Value = null;
        ...
        internal static DbContextScope GetAmbientScope()
        {
            ...
            var instanceIdentifier = instanceIdentifierMap.Value;
