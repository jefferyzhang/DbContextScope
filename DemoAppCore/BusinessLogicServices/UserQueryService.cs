...
namespace Numero3.EntityFramework.Demo.BusinessLogicServices
{
	...
	public class UserQueryService
	{
		...
		public IEnumerable<User> GetUsers(params String[] userIds)
		{
			using (var dbContextScope = _dbContextScopeFactory.CreateReadOnly())
			{
				var dbContext = dbContextScope.DbContexts.Get<UserManagementDbContext>();
		...
		public User GetUserViaRepository(String userId)
		{
			/*
		...
		public async Task<IList<User>> GetTwoUsersAsync(String userId1, String userId2)
		{
			/*
		...
		public User GetUserUncommitted(String userId)
		{
			/*
